...
import io
import re
from sqlalchemy import create_engine, VARCHAR, FLOAT, TEXT, INTEGAR
...
# Print the unique IFOPT values in the filtered DataFrame
unique_ifopt = df["IFOPT"].unique()
print("Unique IFOPT values after filtering:")
print(unique_ifopt)
